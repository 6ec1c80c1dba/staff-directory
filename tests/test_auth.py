...
def test_register(client, app):
    ...
    response = client.post('/auth/register', data={'username': 'test', 'password': 'admin'})
...
@pytest.mark.parametrize(('username', 'password', 'message'), (
    ('a', 'pbkdf2:sha256:50000$TCI4GzcX$0de171a4f4dac32e3364c7ddc7c14f3e2fa61f2d17574483f7ffbb431b4acb2f', b'Incorrect username.'),
